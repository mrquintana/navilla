  ...
  syphilis: {
    ...
    guide: {
      ...
      treatment: {
        ...
        es: 'La sífilis es curable con penicilina G, administrada por inyección. El estadio de la infección determina la dosis y la duración. Las personas alérgicas a la penicilina pueden ser tratadas con doxiciclina. El tratamiento mata las bacterias, pero no puede deshacer el daño causado por la sífilis en etapa tardía.',
      },
      prevention: {
  ...
  mycoplasma_genitalium: {
    ...
    guide: {
      ...
      treatment: {
        ...
        es: 'El MG se trata con antibióticos, pero la **resistencia a los antibióticos es un problema grave**:\n- **Enfoque recomendado**: doxiciclina por 7 días primero, luego azitromicina (si es sensible a macrólidos) o moxifloxacino (si es resistente a macrólidos)\n- Se prefiere la **terapia guiada por resistencia**: primero analizar la resistencia a los macrólidos, luego elegir el antibiótico de segundo paso apropiado\n- Una dosis única de azitromicina sola ya no se recomienda debido a las altas tasas de resistencia\n- El fracaso del tratamiento es cada vez más común: las pruebas de seguimiento para confirmar la cura son esenciales\n\nEvitar el sexo hasta que se confirme que el tratamiento está completo. Las parejas sexuales también deben hacerse la prueba y recibir tratamiento.',
      },
      prevention: {
