...
/**
 * Mock lab provider that calls the demo-mx mock endpoint.
 *
 * <p>Requires {@code orderId} and {@code patientId} credentials.
 */
public class MockDemoMxProvider implements LabProvider {

  private static final String PROVIDER_CODE = "MOCK_DEMO_MX";
